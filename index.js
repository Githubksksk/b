...
client.config = global.config = {
    ...
    status: "online",
    color: "RANDOM",
    footer: "Alegria ❤️ Acer", 
    botdurum: "Alegria ❤️ Acer",
    owners: ["622808887728406539" , ""],

    guild: "893226714040254494",
    logChannel: "895330798352338985", 
    voiceChannel: "893586083361742919",

    token: "ODMzOTM5MzAwNjU5NDk0OTIz.YH5ofw.wwNn6YCbkRe8pG2Ltb1JJMGErI0",
    mongourl: "",
};
